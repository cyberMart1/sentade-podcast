...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">Purposeful Living Admin</a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        @auth('admin')
          <ul class="navbar-nav side-nav" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('podcasts.all')}}" style="margin-left: 20px;">Podcast</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('events.all') }}" style="margin-left: 20px;">Events</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('blogs.all') }}" style="margin-left: 20px;">Blogs</a>
                </li>
                <li class="nav-item">
